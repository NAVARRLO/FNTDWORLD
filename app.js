...
class FNTDWorldApp {
    ...
    showPage(pageId) {
        ...
        // Hide all pages and clear animation/slide classes to avoid residual transforms
        document.querySelectorAll('.page').forEach(page => {
            // remove active and any directional slide classes
            page.classList.remove('active', 'slide-left', 'slide-right', 'slide-in', 'slide-out');
            // reset inline transform in case any JS animation left a transform
            page.style.transform = '';
            // ensure hidden pages are off-screen to the right by default
        ...
        if (targetPage) {
            ...
            // Force a reflow so transition will run predictably
            // eslint-disable-next-line no-unused-expressions
            targetPage.offsetHeight;

            // Activate target page
            targetPage.classList.add('active');
            // Ensure final transform is applied (active class should handle this via CSS)
